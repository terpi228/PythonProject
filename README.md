...
Добавлены функции для чтения финансовых операций из файлов:

- `read_csv_transactions(path)` — считывает транзакции из CSV-файла и возвращает список словарей.
- `read_excel_transactions(path)` — считывает транзакции из Excel-файла и возвращает список словарей.

Формат вывода:
```python
[
    {"date": "2024-10-01", "amount": 1500, "category": "food"},
    {"date": "2024-10-02", "amount": -300, "category": "transport"}
]
