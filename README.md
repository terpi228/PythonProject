...
### Модуль decorators
- Добавлен модуль `decorators.py` с декоратором `log`
- Декоратор логирует выполнение функций (успех/ошибки)
- Поддержка записи в файл или вывод в консоль

### Тестирование
- Написаны тесты с помощью pytest
- Добавлена генерация HTML отчетов (`pytest-html`)
- Отключена проверка типов mypy для модуля
